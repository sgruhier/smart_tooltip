...
class SmartTooltipWithWidget extends StatefulWidget {
  ...
  /// The delay duration before showing the tooltip.
        ...
        switch (widget.position) {
          case TooltipPosition.top:
            if (topSpace >= tooltipHeight &&
              ...
              top = offset.dy - tooltipHeight - widget.offset.dy;
              left = offset.dx + (size.width / 2) - (tooltipWidth / 2) - widget.offset.dx;
            } else {
              // Not enough space at top, check left or right
              if (leftSpace >= rightSpace) {
                // Place it to the left
                left = offset.dx - tooltipWidth - widget.offset.dx;
                top = offset.dy + (size.height / 2) - (tooltipHeight / 2) - widget.offset.dy;
            ...
            child: Material(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(widget.borderRadius), // Tooltip border radius
                ),
